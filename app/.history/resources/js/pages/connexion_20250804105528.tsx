...
export default function Connexion() {
  ...
  return (
    <div className="connexion-dark-container">
      ...
      <div className="con connexion-dark-card animate-slide-in"><div className="con"><img src="build/assets/logo.png" alt="" />
      <h2 className="connexion-dark-title">🎓 Espace Parent</h2></div>
