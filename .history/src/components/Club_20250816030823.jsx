  ...
  return (
    <section ref={containerRef} className="club-section">
      ...
      {clubs.map((club, i) => {
        ...
        // La bulle se centre verticalement lors de son intervalle
        const scale = useTransform(scrollYProgress, [start, start + 0.1, end - 0.1, end], [0.5, 1.5, 1.5, 0.5]);
        const opacity = useTransform(scrollYProgress, [start, start + 0.05, end - 0.05, end], [0, 1, 1, 0]);
        const y = useTransform(scrollYProgress, [start, end], ["100vh", "50vvh"]);
